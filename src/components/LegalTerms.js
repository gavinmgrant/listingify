...
function LegalTerms(props) {
  return (
    <LongContent>
      ...
      <p>
        Welcome to Listingify (“Company”, “we”, “our”, “us”)! As you have just
      ...
      <p>
        ...
        our web pages located at https://www.listingify.com/ operated by
        Listingify.
      </p>
      ...
      <p>
        ...
        https://www.listingify.com/legal/privacy-policy.
      </p>
      ...
      <p>
        ...
        hello@listingify.com so we can try to find a solution. These Terms apply
      ...
      <p>
        If an error occured when purchasing tokens and you provide evidence of
        the error, the number of tokens you purchased that were not credited to
        your account will be added to your account. Email hello@listingify.com
      ...
      <p>
        Listingify has the right but not the obligation to monitor and edit all
      ...
      <p>
        ...
        Listingify and its licensors. Service is protected by copyright,
      ...
      <p>
        ...
        to hello@listingify.com, with the subject line: “Copyright Infringement”
      ...
      <p>
        Listingify has no control over, and assumes no responsibility for the
      ...
      <p>By email: hello@listingify.com.</p>
    </LongContent>
  );
}
