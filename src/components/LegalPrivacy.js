...
function LegalPrivacy(props) {
  return (
    <LongContent>
      ...
      <p>Welcome to Listingify.</p>
      <p>
        Listingify (“us”, “we”, or “our”) operates
        https://www.listingify.com/ (hereinafter referred to as “Service”).
      </p>

      <p>
        Our Privacy Policy governs your visit to https://www.listingify.com/,
      ...
      <h2>2. Definitions</h2>
      <p>
        SERVICE means the https://www.listingify.com/ website operated by
        Listingify.
      </p>
      <p>
      ...
      <h2>5. Use of Data</h2>
      <p>Listingify uses the collected data for various purposes:</p>
      ...
      <p>
        Listingify will take all the steps reasonably necessary to ensure
      ...
      <p>
        Listingify uses remarketing services to advertise on third party
